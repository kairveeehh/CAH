...
const App = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center py-10">
      ...
      <div className="text-3xl pb-3">Cards Against Humanity</div>
    ...
    Draw Black Card
          ...
          {cbc && (
            ...
            >
              ...
              <p className="text-gray-300 text-sm text-center sm:text-base">
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-gray-800 text-white rounded-lg shadow-lg overflow-hidden max-w-md w-full mx-4">
      <div className="p-4 sm:p-6">
